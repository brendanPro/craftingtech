      ...
      <section className="py-12 bg-white sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="text-center">
                <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Pourquoi choisir Crafting Tech ?</h2>
            ...
            <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                    ...
                    <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Expertise technique</h3>
                    <p className="mt-5 text-base text-gray-600 font-pj">Ingénieur logiciel spécialisé en JavaScript/TypeScript, fullstack (backend, frontend, mobile, ops...).</p>
                </div>
                ...
                <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                    ...
                    <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Approche produit</h3>
                    <p className="mt-5 text-base text-gray-600 font-pj">Un développement centré sur vos objectifs business et vos utilisateurs.</p>
                </div>
                ...
                <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                    ...
                    <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Solutions évolutives</h3>
